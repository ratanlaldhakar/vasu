    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ref={ref}
          id={id}
          className={`w-full wobbly border-3 border-pencil bg-white px-4 py-2.5 md:py-3 font-[family-name:var(--font-patrick-var)] text-pencil text-base md:text-lg placeholder:text-erased focus:outline-none focus:ring-3 focus:ring-ballpoint focus:border-ballpoint transition-all duration-100 resize-none ${className}`}
          rows={5}
          {...props}
        />
      </div>
